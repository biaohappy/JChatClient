...
import com.xiaobiao.chatclient.mapper.ChatMineMapper;
...
public class ChatMineService {
    ...
    public ChatMine queryChatMine(String usercode) {
        ChatMine chatMine = chatMineMapper.selectByParam(usercode);
